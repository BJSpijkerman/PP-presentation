...
\addlegendentry{\small Vacuum: $\omega/c = k_x$}

% -----------------------------
% Mode dispersions
% -----------------------------
\addplot[thick, blue]{sqrt(x^2 + 1^2)};
\addlegendentry{\small Mode $m=1$}
\addplot[thick, orange]{sqrt(x^2 + 2^2)};
\addlegendentry{\small Mode $m=2$}
\addplot[thick, green]{sqrt(x^2 + 3^2)};
\addlegendentry{\small Mode $m=3$}
...
\addlegendentry{\small Input $\omega_{\text{in}}/c$}
...
% Region labels
% -----------------------------
\node at (axis cs:4.5,0.3) {\footnotesize No propagation};
\node at (axis cs:4.5,1.3) {\footnotesize Single mode propagation};
\node at (axis cs:4.5,2.3) {\footnotesize Multi mode propagation};
